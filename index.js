...
client.on('message', message => {
  ...
  if (message.content.startsWith(admin + 'setstream')) {
    client.user.setGame(argresult, "https://www.twitch.tv/brokentuber_yt");
...
client.on('message', async message => {
 ...
 Main Commands  :         
         ...
         - +bot : لاظهار معلومات البوت
         
         - +avatar : لاظهار صورتك
		 
         - +savatar : لاظهار صوره السيرفر
         
         - +allbots : لاظهار جميع البوتات في السيرفر
    **`,
            `**
  Main Commands :
...
- +user : لاظهار معلومات حسابك
         ...
         - +roles : لاظهار جميع رولات السيرفر
    **`,
            `**
 '  Admin Commands : 
         ...
         - +bc : برودكاست رساله الى أعضاء السيرفر
         ...
         - +role : اعطاءاعطارتبه لشخص
    **`,
            `**
الكلام الي - +role all : اعطاء رتبه للكل
         
         - +role humans : اعطاء رتبه لشخص
         
         - +role bots : اعطاء رتبه لبوت
         
         - +say : البوت يكرر كلامك
         
         - +embed : كلام بامبد جميل
         
         Voice Commands : 
         
        - +Move all : سحب الجميع الى رومك الصوتي

         Credits Commands  :  

        - +credits : لمعرفه رصيدك

        - +daily : لسحب جائزه يوميه

         لتحويل رصيد الى شخص
        - +credits <المبلغ> <منشن للشخص>
**`
        ];
        let page = 1;
